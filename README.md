...
2. Сбор данных и статистика
    - ipynb для формирования датасета: <https://github.com/AlexForLinux/ai-sstu-2025/blob/main/ai/forming-dataset.ipynb>
    - colab для формирования датасета:: <https://colab.research.google.com/drive/1oMEN5bfms0DFudkMMg4GK-tEwGy_vIsL?usp=sharing>
    - сформированный датасет: <https://drive.google.com/file/d/1uCUT_KKQZcG9dd_SnYWTy4PBv9uB-hIY/view?usp=sharing>
3. Разработка системы
    ...
    - ipynb для обучения моделей: <https://github.com/AlexForLinux/ai-sstu-2025/blob/main/ai/cnn-learning.ipynb>
4. Выходной материал
...
- Фреймворк вывода на устройство: Onnx Mobile
- Архитектура модели: Сверточная Нейронная Сеть EfficientNet B1
...
- Точность (Accuracy): **91.2%**
- Precision, Recall и F1-Score:

| Класс          | Precision | Recall | F1-Score |
|----------------|-----------|--------|----------|
| 0 (Healthy)    | 0.876     | 0.92   | 0.898    |
| 1 (Powdery)    | 0.963     | 0.915  | 0.938    |
| 2 (Rust)       | 0.957     | 0.990  | 0.973    |
| 3 (Slug)       | 0.946     | 0.875  | 0.909    |
| 4 (Spot)       | 0.827     | 0.86   | 0.843    |
